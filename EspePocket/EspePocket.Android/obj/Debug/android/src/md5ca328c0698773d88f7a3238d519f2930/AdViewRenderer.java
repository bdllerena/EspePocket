...
/** @hide */
	...
	static {
		__md_methods = 
			"";
		mono.android.Runtime.register ("EspePocket.Droid.AdViewRenderer, EspePocket.Android, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", AdViewRenderer.class, __md_methods);
	}
	...
	public AdViewRenderer (android.content.Context p0)
	{
		super (p0);
		if (getClass () == AdViewRenderer.class)
			mono.android.TypeManager.Activate ("EspePocket.Droid.AdViewRenderer, EspePocket.Android, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "Android.Content.Context, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", this, new java.lang.Object[] { p0 });
	}
